...
export const ORGANIZER_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/events", labelKey: "dashboard.nav_thank_you", icon: Heart },
    ],
  },
  {
    id: "marketplace",
    ...
    items: [
      ...
      { href: "/dashboard/discovery", labelKey: "dashboard.nav_vendor_discovery", icon: Compass },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/messages", labelKey: "dashboard.nav_notifications", icon: Bell },
    ],
  },
  {
    id: "finance",
    ...
    items: [
      ...
      { href: "/dashboard/wallet", labelKey: "dashboard.nav_payouts", icon: Banknote },
      { href: "/dashboard/wallet", labelKey: "dashboard.nav_transactions", icon: Receipt },
      { href: "/dashboard/wallet", labelKey: "dashboard.nav_revenue", icon: TrendingUp },
    ],
  },
  {
    id: "memories",
    ...
    items: [
      ...
      { href: "/dashboard/memory#guestbook", labelKey: "dashboard.nav_guestbook", icon: BookOpen },
      { href: "/dashboard/memory#gallery", labelKey: "dashboard.nav_gallery", icon: Image },
      { href: "/dashboard/memory#upload", labelKey: "dashboard.nav_media_uploads", icon: Upload },
      { href: "/dashboard/memory", labelKey: "dashboard.nav_legacy_archive", icon: Archive },
    ],
  },
  {
    id: "funeralos",
  ...
  },
  {
    ...
    items: [
      { href: "/dashboard/settings", labelKey: "dashboard.nav_account", icon: UserCircle },
      { href: "/dashboard/settings", labelKey: "dashboard.nav_organization", icon: Building2 },
      { href: "/dashboard/settings", labelKey: "dashboard.nav_team", icon: Users },
      { href: "/dashboard/settings", labelKey: "dashboard.nav_permissions", icon: Shield },
      { href: "/dashboard/settings", labelKey: "dashboard.nav_branding", icon: Palette },
      { href: "/dashboard/settings", labelKey: "dashboard.nav_integrations", icon: Plug },
      { href: "/dashboard/privacy-center", labelKey: "dashboard.nav_privacy", icon: Lock },
      { href: "/dashboard/settings", labelKey: "dashboard.nav_security", icon: Shield },
      { href: "/dashboard/settings", labelKey: "dashboard.nav_billing", icon: CreditCard },
    ],
  },
];
