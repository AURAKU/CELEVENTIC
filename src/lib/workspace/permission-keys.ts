...
export const EventPermissionKey = {
  ...
  SCAN_QR: "SCAN_QR",
  MANAGE_EVENT_QR_ASSETS: "MANAGE_EVENT_QR_ASSETS",
  DOWNLOAD_EVENT_QR_ASSETS: "DOWNLOAD_EVENT_QR_ASSETS",
  MANAGE_VENDOR_ACCESS: "MANAGE_VENDOR_ACCESS",
  VIEW_QR_SCAN_HISTORY: "VIEW_QR_SCAN_HISTORY",
...
> = {
  ...
  MANAGE_EVENT_QR_ASSETS: {
    label: "Manage event QR assets",
    description: "Create and configure Event QR & Pass Hub assets",
    category: "admission",
  },
  DOWNLOAD_EVENT_QR_ASSETS: {
    label: "Download event QR assets",
    description: "Download and print QR packs",
    category: "admission",
  },
  MANAGE_VENDOR_ACCESS: {
    label: "Manage vendor access",
    description: "Create and regenerate shared vendor access passes",
    category: "admission",
  },
  VIEW_QR_SCAN_HISTORY: {
    label: "View QR scan history",
    description: "See admission and vendor scan activity",
    category: "admission",
  },
