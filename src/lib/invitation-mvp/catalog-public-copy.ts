...
export const CATALOG_DEMO_IDENTITIES: Record<string, DemoIdentity> = {
  ...
  "aurelia-editorial-wedding": {
    title: "The Wedding of Enock & Ruth",
    hostName: "Enock & Ruth",
    message: "Together with their families, Enock and Ruth invite you to celebrate their wedding.",
    invitationName: "Enock & Ruth Editorial",
