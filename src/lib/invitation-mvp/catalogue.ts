import { applyPublicCatalogCopy } from "./catalog-public-copy";
...
export const CATALOG_TEMPLATES: CatalogTemplate[] = [
  ...
  },
  {
    ...
    previewGradient: "from-stone-50 via-amber-50 to-orange-50",
    isPremium: true,
    isNew: true,
    mood: "Romantic",
  ...
  // —— Birthday browse Wave (shared neon shell, unique families) ——
  {
    slug: "pastel-balloon-garden",
    name: "Pastel Balloon Garden",
    description:
      "Soft pastel balloon garden birthday with a festive curtain open and cheerful celebration energy.",
    category: "Birthday",
    style: "Playful",
    layoutSlug: "neon-celebration-party",
    previewGradient: "from-pink-200 via-sky-100 to-amber-100",
    isPremium: false,
    isNew: true,
    mood: "Artistic",
    features: ["RSVP", "Gallery", "Music", "Share", "Countdown"],
    tier: "free",
    tags: ["birthday", "pastel", "balloons", "kids"],
    colorFamily: "pastel",
    hasParallax: false,
    creativeBrief: {
      creativeConcept:
        "Pastel Balloon Garden: balloon rise intro into a soft pastel curtain for cake-and-balloon cheer",
      emotionalTone: "joyful",
      visualLanguage: "pastel balloons, soft confetti, garden light, playful type",
      revealMechanic: "pastel birthday curtain open",
      audioMood: "happy celebration cheer",
      outroType: "lanterns",
    },
    experienceOverrides: {
  ...
  {
    slug: "gold-glam-milestone",
    name: "Gold Glam Milestone",
    description:
      "Champagne gold milestone birthday with pink wax seal glam and elegant night energy.",
    category: "Birthday",
    style: "Glam",
    layoutSlug: "neon-celebration-party",
    previewGradient: "from-amber-200 via-rose-100 to-stone-900",
    isPremium: true,
    isNew: true,
    mood: "Luxury",
    features: ["RSVP", "Gallery", "Music", "Share", "Countdown", "QR"],
    tier: "premium",
    tags: ["birthday", "milestone", "gold", "glam"],
    colorFamily: "gold",
    hasParallax: false,
    creativeBrief: {
      creativeConcept:
        "Gold Glam Milestone: foil sparkle intro into a pink wax seal for a champagne birthday night",
      emotionalTone: "glamorous",
      visualLanguage: "champagne gold, pink seal, crystal light, milestone numerals",
      revealMechanic: "pink wax seal",
      audioMood: "soft lounge jazz",
      outroType: "golden sparkles",
    },
    experienceOverrides: {
  ...
  {
    slug: "concert-night-bash",
    name: "Concert Night Bash",
    description:
      "High energy birthday bash with stage curtain drop, concert lights and ticket style RSVP.",
    category: "Birthday",
    style: "Festive",
    layoutSlug: "neon-celebration-party",
    previewGradient: "from-violet-700 via-fuchsia-600 to-black",
    isPremium: true,
    isNew: true,
    mood: "Cinematic",
    features: ["RSVP", "Tickets", "QR", "Music", "Share"],
    tier: "premium",
    tags: ["birthday", "concert", "stage", "bash"],
    colorFamily: "neon",
    hasParallax: false,
    creativeBrief: {
      creativeConcept:
        "Concert Night Bash: party strobe intro into a dark stage curtain with drum celebration energy",
      emotionalTone: "high-energy",
      visualLanguage: "stage lights, concert ticket, drum pulse, crowd energy without faces",
      revealMechanic: "concert curtain",
      audioMood: "african drums celebration",
  ...
  {
    slug: "surprise-gift-soiree",
    name: "Surprise Gift Soiree",
    description:
      "Intimate surprise birthday soiree with balloon burst reveal and warm celebration details.",
    category: "Birthday",
    style: "Milestone",
    layoutSlug: "neon-celebration-party",
    previewGradient: "from-rose-300 via-amber-100 to-teal-100",
    isPremium: false,
    isNew: true,
    mood: "Romantic",
    features: ["RSVP", "Gallery", "Music", "Share", "Countdown"],
    tier: "free",
    tags: ["birthday", "surprise", "gift", "soiree"],
    colorFamily: "warm",
    hasParallax: false,
    creativeBrief: {
      creativeConcept:
        "Surprise Gift Soiree: milestone foil intro into a balloon burst for an intimate birthday reveal",
      emotionalTone: "warm",
      visualLanguage: "gift ribbons, warm gold light, surprise typography, soft confetti",
      revealMechanic: "balloon burst",
      audioMood: "garden piano soft",
      outroType: "see you soon",
    },
    experienceOverrides: {
  ...
  // —— Corporate browse Wave (shared prestige shell, unique families) ——
  {
    slug: "executive-boardroom-brief",
    ...
    style: "Executive",
    layoutSlug: "corporate-prestige-summit",
    previewGradient: "from-slate-100 via-teal-50 to-slate-800",
    isPremium: true,
    isNew: true,
    mood: "Luxury",
    features: ["RSVP", "Agenda", "Speakers", "Calendar", "Maps"],
    tier: "premium",
    tags: ["corporate", "boardroom", "briefing", "executive"],
    colorFamily: "slate-teal",
    hasParallax: false,
    creativeBrief: {
      creativeConcept:
      ...
      revealMechanic: "briefing folder unfold",
      audioMood: "soft corporate ambient",
      outroType: "closing curtain",
    },
    experienceOverrides: {
  ...
  },
  {
    ...
    style: "Launch",
    layoutSlug: "corporate-prestige-summit",
    previewGradient: "from-teal-700 via-cyan-600 to-slate-950",
    isPremium: true,
    isNew: true,
    mood: "Cute",
    features: ["RSVP", "QR", "Gallery", "Music", "Share"],
    tier: "premium",
    tags: ["corporate", "launch", "product", "pulse"],
    colorFamily: "teal-cyan",
    hasParallax: false,
    creativeBrief: {
      creativeConcept:
      ...
      audioMood: "modern electronic soft",
  ...
  },
  {
    ...
    isNew: true,
    mood: "Luxury",
    features: ["RSVP", "QR", "Agenda", "Maps", "Music"],
    tier: "premium",
    tags: ["corporate", "investor", "pitch", "pass"],
    colorFamily: "onyx-gold",
    hasParallax: false,
    creativeBrief: {
      creativeConcept:
      ...
      revealMechanic: "investor pass open",
      audioMood: "soft jazz lounge",
      outroType: "credits page",
    },
    experienceOverrides: {
  ...
  },
  {
    ...
    style: "Boardroom",
    layoutSlug: "corporate-prestige-summit",
    previewGradient: "from-indigo-950 via-slate-900 to-teal-900",
    isPremium: false,
    isNew: true,
    mood: "Classic",
    features: ["RSVP", "Agenda", "Speakers", "Calendar", "Music", "Share"],
    tier: "free",
    tags: ["corporate", "keynote", "agenda", "summit"],
    colorFamily: "indigo-teal",
    hasParallax: false,
    creativeBrief: {
      creativeConcept:
        "Keynote Agenda Flip: keynote beam into an agenda flip for summit programming",
      emotionalTone: "authoritative",
      visualLanguage: "stage beam, agenda cards, speaker portraits frames, teal markers",
      revealMechanic: "agenda flip",
      audioMood: "corporate piano soft",
      outroType: "see you soon",
    },
    experienceOverrides: {
  ...
  },
  {
    ...
    description:
      "A luxury fashion lunch invitation: couture envelope, invitation card rise, boutique film and editorial lookbook for a flagship soft opening.",
    category: "Lunch",
    style: "Editorial",
    ...
    tier: "premium",
    tags: ["lunch", "fashion", "flagship", "boutique", "launch", "editorial"],
    ...
    creativeBrief: {
      creativeConcept:
        "Femmora Flagship Soft Opening — a lunch invitation with couture envelope, card rise and atelier film",
  ...
  },
  {
    ...
    isNew: true,
    mood: "Classic",
    features: ["Tribute", "Attendance", "Calendar", "Maps", "Music", "Gallery", "RSVP", "Memory"],
    tier: "free",
  ...
  },
  {
    ...
    isNew: true,
    mood: "Classic",
    features: ["Tribute", "Attendance", "Calendar", "Maps", "Music", "Gallery", "RSVP"],
    tier: "free",
  ...
  },
  {
    ...
    isNew: true,
    mood: "Traditional",
    features: ["Tribute", "Attendance", "Calendar", "Maps", "Music", "Gallery", "RSVP", "Programme"],
    tier: "free",
  ...
  // —— Ghanaian funeral browse Wave (shared memorial shell, unique families) ——
  {
    slug: "black-red-cloth-rite",
    ...
    style: "Solemn",
    layoutSlug: "memorial-candle-tribute",
    previewGradient: "from-black via-red-950 to-neutral-900",
    isPremium: true,
    isNew: true,
    mood: "Dignified",
    features: [
    ...
    tier: "premium",
    tags: ["ghanaian", "black-red", "akan", "mourning"],
    colorFamily: "black-red",
    hasParallax: true,
    blueprintId: "funeral-akan-cloth-v1",
    themeId: "black-red-cloth",
    motifPackId: "akan-mourning-cloth",
    motionProfileId: "solemn",
    performanceClass: "light",
    creativeBrief: {
      creativeConcept:
        "Black Red Cloth Rite: mourning cloth drape into a black wax seal for an Akan funeral announcement",
      emotionalTone: "dignified",
      visualLanguage: "black and red mourning cloth, silver type, portrait honour frame, family lineage",
      revealMechanic: "black wax seal press",
      audioMood: "soft acoustic choir warmth",
      outroType: "final quote of gratitude",
    },
    experienceOverrides: {
  ...
  },
  {
    ...
    style: "Homegoing",
    layoutSlug: "memorial-candle-tribute",
    previewGradient: "from-neutral-100 via-stone-50 to-neutral-200",
    isPremium: false,
    isNew: true,
    mood: "Peaceful",
    features: [
    ...
    tier: "free",
    tags: ["ghanaian", "black-white", "christian", "thanksgiving"],
    colorFamily: "ivory",
    hasParallax: false,
    blueprintId: "funeral-homegoing-v1",
    themeId: "white-cloth-homegoing",
    motifPackId: "ivory-veil",
    motionProfileId: "solemn",
    performanceClass: "light",
    creativeBrief: {
      creativeConcept:
        "White Cloth Homegoing: ivory stillness into a royal envelope for Christian thanksgiving rites",
      emotionalTone: "peaceful",
      visualLanguage: "ivory cloth, black type, soft cross light, serene portrait, thanksgiving programme",
      revealMechanic: "royal envelope open",
      audioMood: "crystal strings soft",
      outroType: "thank you fade",
    },
    experienceOverrides: {
  ...
  },
  {
    ...
    layoutSlug: "memorial-candle-tribute",
    previewGradient: "from-amber-950 via-neutral-950 to-red-950",
    isPremium: true,
    isNew: true,
    mood: "Heritage",
    features: [
    ...
    tier: "premium",
    tags: ["ghanaian", "kente", "heritage", "banner"],
    colorFamily: "kente-gold",
    hasParallax: true,
    blueprintId: "funeral-kente-banner-v1",
    themeId: "kente-border-farewell",
    motifPackId: "kente-border",
    motionProfileId: "solemn",
    performanceClass: "light",
    creativeBrief: {
      creativeConcept:
        "Kente Border Farewell: heritage weave intro into a kente envelope for a Ghanaian funeral banner",
      emotionalTone: "reverent",
      visualLanguage: "kente border bands, gold foil names, black field, clan honour, programme chapters",
      revealMechanic: "kente envelope open",
      audioMood: "warm ambient cinematic",
      outroType: "memory slideshow",
    },
    experienceOverrides: {
  ...
  },
  {
    ...
    style: "Vigil",
    layoutSlug: "memorial-candle-tribute",
    previewGradient: "from-stone-950 via-amber-950 to-black",
    isPremium: false,
    isNew: true,
    mood: "Communal",
    features: [
    ...
    tier: "free",
    tags: ["ghanaian", "one-week", "wake", "vigil"],
    colorFamily: "lantern-dusk",
    hasParallax: false,
    blueprintId: "funeral-vigil-notice-v1",
    themeId: "one-week-vigil",
    motifPackId: "vigil-lantern",
    motionProfileId: "solemn",
    performanceClass: "light",
    creativeBrief: {
      creativeConcept:
        "One Week Vigil Notice: lantern intro into a classic envelope for wake keeping and burial logistics",
      emotionalTone: "communal",
      visualLanguage: "poster notice layout, date bands, venue map cues, wake keeping and burial columns",
      revealMechanic: "classic envelope open",
      audioMood: "soft memorial piano",
      outroType: "upload memories",
    },
    experienceOverrides: {
...
export function getCatalogTemplate(slug: string) {
  ...
  return found ? applyPublicCatalogCopy(found) : undefined;
}
...
export function filterCatalogTemplates(filters: {
  ...
  return CATALOG_TEMPLATES.map(applyPublicCatalogCopy).filter((t) => {
...
const BROWSE_FAMILY_BY_SLUG: Record<string, string> = {
  ...
  // Funeral shell: collapse prior Wave-1 funeral SKUs; four Ghanaian browse families stay distinct
  "memorial-candle-tribute": "family-candle-elegy",
  "candlelight-farewell": "family-candle-elegy",
  "candlelight-elegy-pages": "family-candle-elegy",
  "white-lily-rest": "family-candle-elegy",
  "white-lily-memorial-pages": "family-candle-elegy",
  "royal-mourning-lite": "family-candle-elegy",
  "royal-mourning-pages": "family-candle-elegy",
  "black-red-cloth-rite": "family-black-red-cloth",
  "white-cloth-homegoing": "family-white-cloth-homegoing",
  "kente-border-farewell": "family-kente-border-farewell",
  "one-week-vigil-notice": "family-one-week-vigil",
  // Birthday shell: keep Electric Pulse, plus four distinct birthday families
  "neon-celebration-party": "family-electric-pulse",
  "pastel-balloon-garden": "family-pastel-balloon",
  "gold-glam-milestone": "family-gold-glam",
  "concert-night-bash": "family-concert-bash",
  "surprise-gift-soiree": "family-surprise-soiree",
  // Corporate shell: keep Platinum Summit, plus four distinct corporate families
  "corporate-prestige-summit": "family-platinum-summit",
  "executive-boardroom-brief": "family-boardroom-brief",
...
const BROWSE_FAMILY_PREFERRED_SLUG: Record<string, string> = {
  ...
  "family-candle-elegy": "memorial-candle-tribute",
  "family-black-red-cloth": "black-red-cloth-rite",
  "family-white-cloth-homegoing": "white-cloth-homegoing",
  "family-kente-border-farewell": "kente-border-farewell",
  "family-one-week-vigil": "one-week-vigil-notice",
  "family-electric-pulse": "neon-celebration-party",
  "family-pastel-balloon": "pastel-balloon-garden",
  "family-gold-glam": "gold-glam-milestone",
  "family-concert-bash": "concert-night-bash",
  "family-surprise-soiree": "surprise-gift-soiree",
  "family-platinum-summit": "corporate-prestige-summit",
  "family-boardroom-brief": "executive-boardroom-brief",
...
export function getBrowseCatalogTemplates(options?: BrowseCatalogOptions): CatalogTemplate[] {
  ...
  return CATALOG_TEMPLATES.filter((template) => winners.has(template.slug)).map(
    applyPublicCatalogCopy
  );
}
