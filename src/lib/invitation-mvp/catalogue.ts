...
export const CATALOG_TEMPLATES: CatalogTemplate[] = [
  ...
  // —— Ghanaian funeral browse Wave (shared memorial shell, unique families) ——
  {
    ...
    isNew: true,
    mood: "Dignified",
    features: ["Pages", "Tribute", "Attendance", "Calendar", "Maps", "Music"],
    tier: "premium",
  ...
  },
  {
    ...
    isNew: true,
    mood: "Peaceful",
    features: ["Pages", "Thanksgiving", "Attendance", "Calendar", "Maps", "Music"],
    tier: "free",
  ...
  },
  {
    ...
    isNew: true,
    mood: "Heritage",
    features: ["Pages", "Tribute", "Attendance", "Calendar", "Maps", "Music", "Gallery"],
    tier: "premium",
  ...
  },
  {
    ...
    isNew: true,
    mood: "Communal",
    features: ["Notice", "Wake Keeping", "Attendance", "Calendar", "Maps", "Music"],
    tier: "free",
