...
export const CATALOG_TEMPLATES: CatalogTemplate[] = [
  ...
  },
  {
    ...
    description:
      "Luxury cinematic wedding — blush floral envelope, champagne wax seal & golden gate reveal into a fully editable invitation",
    category: "Wedding",
    style: "Luxury",
    layoutSlug: "forever-afaris-wedding",
    previewGradient: "from-rose-100 via-orange-50 to-amber-50",
    isPremium: true,
    isNew: true,
    mood: "Romantic",
    features: [
