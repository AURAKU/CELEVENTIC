...
const DNA: Record<InvitationLayoutSlug, TemplateExperienceDNA> = {
  ...
  "forever-afaris-wedding": {
    ...
    outroExperience: "golden-sparkles",
    defaultAudioCategory: "piano",
    defaultAudioTrackId: "layout-forever-afaris-wedding",
  ...
  "seraphine-champagne-wedding": {
    ...
    defaultAudioCategory: "wedding",
    defaultAudioTrackId: "layout-seraphine-champagne-wedding",
...
export function enrichDesignWithExperienceDNA(design: InvitationDesignConfig): InvitationDesignConfig {
  ...
  return {
    ...
    experience: {
      ...
      welcomeFontFamily: userExp.welcomeFontFamily,
      welcomeFontScale: userExp.welcomeFontScale,
      welcomeTextColor: userExp.welcomeTextColor,
      welcomeAccentColor: userExp.welcomeAccentColor,
      welcomeScrim: userExp.welcomeScrim,
