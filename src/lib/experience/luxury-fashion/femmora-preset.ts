...
export const FEMMORA_HOUSE_DEFAULTS: LuxuryFashionHouseConfig = mergeFashionHouse(
  LUXURY_FASHION_HOUSE_DEFAULTS,
  {
    ...
    rsvpLede: "Yes, maybe, or unable to attend, we can deliver wherever you are.",
    ...
    countdownAfterKicker: "Shop is open",
    countdownAfterLabel: "Walk-in now. We are ready to serve you.",
