...
export const CINEMATIC_THEMES: Record<CinematicLayoutSlug, CinematicTheme> = {
  "royal-emerald-wedding": {
    ...
    category: "Wedding",
    tagline: "Gold light into embossed emerald wax seal — press to open",
    ...
    config: {
      ...
      studio: { revealMode: "envelope", buttonStyle: "embossed-royal", buttonPosition: "center", fullScreen: true, headingSize: 32, bodySize: 15, scriptSize: 26 },
    },
  },
  "midnight-velvet-reception": {
    ...
    category: "Wedding",
    tagline: "Film title into magazine cover — swipe page-turn chapters",
    ...
    config: {
      ...
      studio: { revealMode: "curtain", buttonStyle: "editorial-underline", fullScreen: true },
    },
  },
  "kente-heritage-union": {
  ...
  "floral-garden-romance": {
    ...
    config: {
      ...
      studio: { revealMode: "envelope", buttonStyle: "floral-edge", fullScreen: true },
    },
  },
  "passport-destination-wedding": {
  ...
  "memorial-candle-tribute": {
    ...
    category: "Funeral",
    tagline: "Soft light into unlit candle — tap to light, timeline tribute",
    ...
    config: {
      ...
      studio: { revealMode: "envelope", buttonStyle: "solemn", fullScreen: true },
      experience: {
        openingExperience: "wax-seal-black",
  ...
  "corporate-prestige-summit": {
    ...
    category: "Corporate",
    tagline: "Kinetic grid into corporate curtain — agenda precision",
    ...
    config: {
      ...
      studio: { revealMode: "none", buttonStyle: "corporate-solid", fullScreen: true },
    },
  },
};
