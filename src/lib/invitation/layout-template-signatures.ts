...
export const LAYOUT_SIGNATURE_FEATURES: Record<string, string[]> = {
  ...
  "royal-emerald-wedding": ["Palace entrance", "Ken-burns gallery", "Emerald particles", "Royal orchestra", "Seating"],
  "midnight-velvet-reception": ["Velvet curtain reveal", "Film-strip gallery", "Midnight jazz", "Champagne menu", "RSVP"],
  "kente-heritage-union": ["Kente envelope reveal", "Stacked card gallery", "Drum celebration", "Heritage story", "Seating"],
  "floral-garden-romance": ["Flower bloom reveal", "Floating memories", "Engagement story", "Romantic wedding score", "Countdown"],
  ...
  "memorial-candle-tribute": ["Candle zoom reveal", "Solemn gallery", "Memorial piano", "Tribute memory", "Contributions"],
  "neon-celebration-party": ["Confetti burst reveal", "Neon grid gallery", "EDM energy", "Ticket QR", "Share"],
  "corporate-prestige-summit": ["Film countdown reveal", "Agenda timeline", "Summit presentation", "Check-in QR", "Seating"],
