...
export const LAYOUT_ENABLED_TABS: Record<string, HubTabId[]> = {
  ...
  "forever-afaris-wedding": ["invitation", "countdown", "timeline", "venue", "gallery", "memory", "rsvp"],
...
export const LAYOUT_SIGNATURE_FEATURES: Record<string, string[]> = {
  ...
  "forever-afaris-wedding": [
    "Blush envelope + champagne wax seal",
    "Golden gate opens from the centre",
    "Order of the day timeline",
    "Ladies & gents dress code",
    "Memory vault upload",
  ],
