...
export function renderTemplateHero(ctx: TemplateHeroContext) {
  ...
  switch (layout) {
    ...
    case "luxury-fashion-flagship":
      return (
        <HeroShell className="max-w-xl">
          <p className="text-[10px] uppercase tracking-[0.42em] mb-4" style={{ color: secondary }}>{intro || "Opening"}</p>
          <h1 className="font-[family-name:var(--font-marcellus)] text-3xl sm:text-5xl tracking-[0.28em] uppercase" style={{ color: primary }}>{name1 || "The House"}</h1>
