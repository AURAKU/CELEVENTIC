...
export function HeroLayoutView({
  ...
  const rootClass = "invitation-copy-root hero-layout-root inv-text-on-dark inv-phrase-emphasis";
  ...
  switch (layoutId) {
    ...
    case "lace-frame":
      return (
        <div className={`relative px-10 py-12 max-w-md mx-auto text-center ${rootClass}`}>
          ...
          <p className="text-xs italic inv-caption-on-dark mb-6 font-[family-name:var(--font-cormorant)]">{intro}</p>
          <h1 className="font-[family-name:var(--font-playfair)] text-3xl" style={{ color: primary }}>{name1}</h1>
          {name2 && <p className="text-xl mt-2 inv-caption-on-dark">& {name2}</p>}
          <p className="mt-8 text-sm tracking-widest uppercase inv-muted-on-dark">{dateLine}</p>
        </div>
      );

    case "hexagon-stack":
      return (
        <div className={`text-center px-6 max-w-lg mx-auto ${rootClass}`}>
          ...
          {name2 && <p className="text-2xl mt-2 inv-caption-on-dark font-[family-name:var(--font-great-vibes)]">{name2}</p>}
          <p className="mt-8 text-xs uppercase tracking-[0.45em] inv-muted-on-dark">{dateLine}</p>
        </div>
      );
    ...
    case "rings-spotlight":
      return (
        <div className={`text-center px-8 max-w-md mx-auto ${rootClass}`}>
          ...
          <p className="mt-8 text-xs inv-muted-on-dark uppercase tracking-[0.35em]">{intro}</p>
    ...
    case "media-canvas":
      return (
        <div className={`text-left px-8 max-w-xl mx-auto w-full ${rootClass}`}>
          <p className="text-xs uppercase tracking-[0.5em] mb-4 inv-muted-on-dark">{intro}</p>
          <h1 className="font-display text-4xl sm:text-5xl font-bold leading-none" style={{ color: primary }}>{name1}</h1>
          {name2 && <p className="text-2xl mt-3 font-light inv-caption-on-dark">{name2}</p>}
          <div className="mt-10 inline-block border-l-4 pl-4" style={{ borderColor: secondary }}>
            <p className="text-sm font-medium">{dateLine}</p>
            <p className="text-xs inv-muted-on-dark mt-1">{time}</p>
          </div>
        </div>
      );
    ...
    case "glass-frost":
      return (
        <div className={`text-center px-8 max-w-md mx-auto rounded-3xl border border-white/20 bg-white/10 backdrop-blur-xl py-10 shadow-[0_8px_32px_rgba(56,189,248,0.15)] inv-text-on-glass ${rootClass}`}>
    ...
    case "garden-card":
      return (
        <div className={`text-center px-8 max-w-md mx-auto ${rootClass}`}>
          ...
          {name2 && <p className="text-3xl mt-2 font-[family-name:var(--font-great-vibes)] inv-caption-on-dark">{name2}</p>}
    ...
    case "royal-palace":
      return (
        <div className={`text-center px-8 max-w-lg mx-auto ${rootClass}`}>
    ...
    case "velvet-stage":
      return (
        <div className={`text-center px-8 max-w-md mx-auto ${rootClass}`}>
          ...
          <p className="mt-6 text-xs uppercase tracking-[0.4em] inv-muted-on-dark">{intro}</p>
    ...
    case "kente-weave":
      return (
        <div className={`text-center px-6 max-w-md mx-auto ${rootClass}`}>
          ...
          <p className="mt-6 text-xs uppercase tracking-[0.35em] inv-muted-on-dark">{intro}</p>
    ...
    case "boarding-pass":
      return (
        <div className={`max-w-sm mx-auto px-4 ${rootClass}`}>
          <div className="rounded-xl border-2 border-dashed border-teal-400/50 bg-teal-950/50 p-6 text-left relative">
            ...
            <div className="flex justify-between mt-6 text-xs inv-muted-on-dark">
    ...
    case "memorial-candle":
      return (
        <div className={`text-center px-8 max-w-md mx-auto ${rootClass}`}>
          ...
          <p className="mt-6 text-xs uppercase tracking-[0.4em] inv-muted-on-dark">{intro}</p>
          <p className="mt-4 text-sm inv-caption-on-dark">{dateLine}</p>
        </div>
      );
    ...
    case "corporate-grid":
      return (
        <div className={`text-left px-8 max-w-xl mx-auto w-full ${rootClass}`}>
          ...
          <p className="mt-8 text-sm font-mono inv-muted-on-dark">{dateLine} · {time}</p>
        </div>
      );

    case "editorial-split":
      return (
        <div className={`flex flex-col sm:flex-row items-center gap-8 px-8 max-w-2xl mx-auto ${rootClass}`}>
          <div className="sm:w-1/2 text-center sm:text-left">
            <p className="uppercase tracking-[0.35em] text-xs inv-muted-on-dark mb-4" style={{ color: secondary, fontFamily: fonts?.body }}>{intro}</p>
          ...
          <div className="sm:w-1/2 text-center sm:text-right border-t sm:border-t-0 sm:border-l border-white/20 pt-6 sm:pt-0 sm:pl-8">
            ...
            <p className="mt-2 text-sm inv-muted-on-dark">{time}</p>
          </div>
        </div>
      );
    ...
    case "fullscreen-type":
      return (
        <div className={`text-center px-6 max-w-3xl mx-auto ${rootClass}`}>
          <h1 className="font-display text-5xl sm:text-7xl font-bold leading-[0.95] tracking-tight" style={{ color: primary }}>
            {name1}
            {name2 && <span className="block text-3xl sm:text-4xl mt-4 inv-caption-on-dark font-light">{name2}</span>}
          </h1>
          <p className="mt-10 text-xs uppercase tracking-[0.5em] inv-muted-on-dark">{intro}</p>
    ...
    case "magazine-stack":
      return (
        <div className={`text-left px-8 max-w-md mx-auto ${rootClass}`}>
          <p className="text-[10px] uppercase tracking-[0.5em] inv-muted-on-dark mb-2">Feature</p>
          <h1 className="font-display text-4xl font-black uppercase leading-[0.9]" style={{ color: primary }}>{name1}</h1>
          {name2 && <p className="text-2xl font-light mt-2 inv-caption-on-dark">{name2}</p>}
          <div className="mt-8 pt-4 border-t border-white/20">
            <p className="text-xs uppercase tracking-widest inv-muted-on-dark">{dateLine}</p>
            <p className="text-sm mt-1 inv-caption-on-dark">{time}</p>
          </div>
        </div>
      );
    ...
    default:
      return (
        <div className={`flex flex-col items-center justify-center text-center px-8 max-w-lg mx-auto ${rootClass}`}>
          <p className="uppercase tracking-[0.4em] text-xs inv-muted-on-dark mb-6" style={{ color: secondary, fontFamily: fonts?.body }}>{intro}</p>
          <h1 className="font-[family-name:var(--font-cinzel)] text-3xl sm:text-4xl md:text-5xl uppercase tracking-[0.08em] leading-tight" style={{ color: primary }}>
            {name1}
            {name2 && (<><span className="block my-3 text-lg inv-muted-on-dark">&</span>{name2}</>)}
          </h1>
