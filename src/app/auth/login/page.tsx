...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const dest = adminRoles.includes(session?.user?.role ?? "") ? "/admin" : "/dashboard";
    router.push(dest);
    router.refresh();
  }

  return (
    <AuthLayout title="Welcome Back" subtitle="Sign in to your Celeventic account">
      ...
      <Button
        variant="outline"
        className="w-full"
        onClick={() => signIn("google", { callbackUrl: resolveAuthCallbackUrl("/dashboard") })}
      >
